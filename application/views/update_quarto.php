<?php $this->load->view('includes/head') ?>	
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(<?= base_url('assets/images/novo-quarto.jpg') ?>)">
				...
				<div class="col-md-12 col-md-offset-0 text-center">
					<div class="row row-mt-15em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
							...
							<h1 class="cursive-font">Edição de Quarto!</h1>	
						</div>						
					</div>
				</div>
			</div>
			...
			<div class="row text-center">
				<div class="col-md-12">
					<div class="col-md-12 animate-box">
						<h3><?= $quarto->TituloQuarto ?></h3>
						<form action="<?= base_url('Quartos/update') ?>" method="post" name="form_update_quarto" id="form_update_quarto" class="text-left" enctype="multipart/form-data">
								<!-- ID do Quarto -->
							...
							<div class="form-row">
								<div class="col-md-6">
									...
									<input type="text" name="titulo" id="titulo" class="form-control" placeholder="Ex: Vaguinha Braba!" maxlength="100" required value="<?= $quarto->TituloQuarto ?>">
								</div>

								<div class="col-md-3">
									<label for="valor" id="label_user">Preço R$<span style="color: red;">*</span></label>
									<input type="number" name="valor" id="valor" step="0.01" class="form-control" required value="<?= $quarto->Preco ?>">
								</div>
								...
								<div class="col-md-3">
									...
									<select name="tipo" id="tipo" class="form-control" required>
										...
										<option value="0" <?= $quarto->TipoQuarto == 0 ? 'selected':''?>>Standrad</option>
										<option value="1" <?= $quarto->TipoQuarto == 1 ? 'selected':''?>>Superior</option>
										<option value="2" <?= $quarto->TipoQuarto == 2 ? 'selected':''?>>Deluxe</option>
									</select>
								</div>
							</div><!-- /row -->
							...
							<div class="form-row">
								<div class="col-md-12">
									...
									<textarea name="descricao" id="descricao" class="form-control" rows="5" required placeholder="Escreva um breve parágrafo descrevendo o quarto" maxlength="400" minlength="70"><?= $quarto->DescricaoQuarto ?></textarea>
								</div>
							</div>
							...
							<div class="form-row">
								<div class="col-md-12">
									<div class="form-group text-center">
										...
										<a href="<?= base_url('excluir-quarto/'.$quarto->IDQuarto) ?>" class="btn btn-primary btn-cadastro">Excluir Quarto</a>
									</div>
								</div>
							</div>
