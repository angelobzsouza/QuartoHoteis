	<footer id="gtco-footer" role="contentinfo" style="background-image: url(<?= base_url('assets/images/background-general.jpg') ?>); background-size: 100% 200%" data-stellar-background-ratio="0.5">
				...
				<div class="col-md-12 text-center">
					<div class="gtco-widget">
						...
						<ul class="gtco-quick-contact">
							<li><a href="#"><i class="icon-phone"></i>(15) 99447-5262</a></li>
							<li><a href="#"><i class="icon-mail2"></i>angelo.bz.souza@gmail.com</a></li>
						</ul>
					</div>
				<div class="col-md-12 text-center copyright">
					<p><small class="block">&copy; QuartoHoteis. All Rights Reserved.</small> 
				</div>
			</div>
		</div>
	</footer>
